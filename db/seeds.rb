...
b1 = Bike.new(color: "red", size: "S", price: 15, user: val, address: "107 rue Balguerie Stuttenberg, Bordeaux", description: "VTC vert pour adulte")
b2 = Bike.new(color: "green", size: "M", price: 20, user: soraya, address: "100 rue Notre Dame, Bordeaux", description: "Vélo de course bg")
b3 = Bike.new(color: "white", size: "L", price: 25, user: kiki, address: "cité du vin, Bordeaux", description: "VTT trop stylé")
